            ...
            <section className="book-details">
                <div className="book-details-data">
                    <div className="book-detail">
                        ...
                        <h1>{book.subtitle}</h1>
                        <span>by </span>
                        {book.authors.map(author => <span key={book.id + author}>{author}</span>)}
                    </div>
                    <div className="book-detail">
                    ...
                    <div className="book-detail">
                        <h2>New / Vintage: </h2>
                        {currentYear - book.publishedDate > 10  ? <h3>Vintage</h3> : <h3>New</h3>}
                    </div>
                    <div className="book-detail">
                        <h2>Price: </h2>
                        <h1 className={amountClass}>{book.listPrice.amount} {book.listPrice.currencyCode}</h1>
                    </div>
